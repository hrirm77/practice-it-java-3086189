...
public class MenuBuilder {
  public static void main(String[] args) {
    ...
    MenuItem starter = new MenuItem("Cucumber Salad");
    ...
    MenuItem mainCourse = new MenuItem("Mutton Biryani");
    ...
    MenuItem dessert = new MenuItem("Chocolate Lavacake from Chili's");
